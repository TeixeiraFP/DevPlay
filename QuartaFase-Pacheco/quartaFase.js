...
while(true){
    if(terceiraFase === 1 || terceiraFase ===2 ){
        ...
        terceiraFase = parseInt( prompt("Trello = 1\n GitHub = 2"));
    }
}
...
function fase (terceiraFase)
{
    if (terceiraFase === 2)
    {
        ...
        <main class="container-principal">
            ...
            Você ajudou Pacheco a dar seus primeiros passos para conquistar o mundo Dev, <br>
            sua jornada no jogo chegou ao FIM! Esperamos que assim como Pacheco você também <br>
